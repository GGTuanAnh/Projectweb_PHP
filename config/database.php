...
return [
    // Default connection (kept sqlite as you were using database/database.sqlite)
    ...
    'connections' => [
        ...
        // Optional secondary MySQL connection for analytics / visualization
        // Remove if you don't need it now.
        'analytics_mysql' => [
            'driver' => 'mysql',
